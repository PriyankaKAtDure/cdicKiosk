...
export default function Forms() {
  ...
  return (
    ...
    <div className="patientbg patientMainSection">
      ...
      <Box p={4} className="patientSection patientFormSection">
        ...
        <Box mb={4} p={2} border="1px solid #e0e0e0" borderRadius={2} boxShadow={1} className="boxCard">
          ...
          {currentTab == "step2" ?
            <Grid container spacing={2}>
              <Grid item xs={12} lg={12} className="d-flex justify-content-center align-items-start gap-10px flex-direction-column ">
              <label>Gender</label>
